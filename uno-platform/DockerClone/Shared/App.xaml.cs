...
namespace DockerClone
{
	...
	{
		public static bool FullResolution = true;
			...
			var unused = Windows.UI.Xaml.Window.Current.Dispatcher.RunAsync(
				...
				async () =>
				{
					...
					while (true)
					{
						...
						{
							Console.Error.WriteLine($"Error generating view statistic:: {ex.StackTrace}");
						}
					}
				}
			);
		...
		protected override void OnLaunched(LaunchActivatedEventArgs e)
		{
			...
			if (e.PrelaunchActivated == false)
			{
						...
						RuntimeInformation.OSArchitecture == Architecture.Arm64))
				{
					...
					//GtkHost.Window.Resize(1138, 640);
					GtkHost.Window.Resize(1024, 600);
				}
